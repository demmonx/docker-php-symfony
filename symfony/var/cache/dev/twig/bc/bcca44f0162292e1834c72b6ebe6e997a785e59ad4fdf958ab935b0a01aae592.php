...
class __TwigTemplate_8d73534e17cdd283bf6efe31a7557f45bb2abe89a084b91fb95a4c46138f262c extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
            ...
            echo "</span></h3>
                ...
                <div class=\"tab-content\">
                    ...
                    ";
            // line 83
            echo twig_call_macro($macros["helper"], "macro_render_bus_messages", [(isset($context["messages"]) || array_key_exists("messages", $context) ? $context["messages"] : (function () { throw new RuntimeError('Variable "messages" does not exist.', 83, $this->source); })()), true], 83, $this->getSourceContext());
            echo "
                </div>
            </div>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["bus"]) {
                ...
                echo "</code> bus</p>
                        ";
                // line 95
                echo twig_call_macro($macros["helper"], "macro_render_bus_messages", [(isset($context["messages"]) || array_key_exists("messages", $context) ? $context["messages"] : (function () { throw new RuntimeError('Variable "messages" does not exist.', 95, $this->source); })())], 95, $this->getSourceContext());
                echo "
                    </div>
                </div>
            ";
...
{% macro render_bus_messages(messages, showBus = false) %}
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/messenger.html.twig", "/var/www/cv/vendor/symfony/web-profiler-bundle/Resources/views/Collector/messenger.html.twig");
    }
}

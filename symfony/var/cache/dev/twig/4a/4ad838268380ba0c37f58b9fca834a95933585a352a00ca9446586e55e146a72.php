...
class __TwigTemplate_111e7cb8b0c0129965e7f1912de4601cec0c44487620feedb7a310e738921e02 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        <div class=\"sf-tabs\">
            ...
            if (twig_test_empty((isset($context["info_and_error_logs"]) || array_key_exists("info_and_error_logs", $context) ? $context["info_and_error_logs"] : (function () { throw new RuntimeError('Variable "info_and_error_logs" does not exist.', 78, $this->source); })()))) {
                ...
                // line 83
                echo "                        ";
                echo twig_call_macro($macros["helper"], "macro_render_table", [(isset($context["info_and_error_logs"]) || array_key_exists("info_and_error_logs", $context) ? $context["info_and_error_logs"] : (function () { throw new RuntimeError('Variable "info_and_error_logs" does not exist.', 83, $this->source); })()), "info", true], 83, $this->getSourceContext());
                echo "
                    ";
            }
            // line 85
            ...
            if (twig_test_empty((isset($context["deprecation_logs"]) || array_key_exists("deprecation_logs", $context) ? $context["deprecation_logs"] : (function () { throw new RuntimeError('Variable "deprecation_logs" does not exist.', 95, $this->source); })()))) {
                ...
                // line 100
                echo "                        ";
                echo twig_call_macro($macros["helper"], "macro_render_table", [(isset($context["deprecation_logs"]) || array_key_exists("deprecation_logs", $context) ? $context["deprecation_logs"] : (function () { throw new RuntimeError('Variable "deprecation_logs" does not exist.', 100, $this->source); })()), "deprecation", false, true], 100, $this->getSourceContext());
                echo "
                    ";
            }
            // line 102
            ...
            if (twig_test_empty((isset($context["debug_logs"]) || array_key_exists("debug_logs", $context) ? $context["debug_logs"] : (function () { throw new RuntimeError('Variable "debug_logs" does not exist.', 110, $this->source); })()))) {
                ...
                // line 115
                echo "                        ";
                echo twig_call_macro($macros["helper"], "macro_render_table", [(isset($context["debug_logs"]) || array_key_exists("debug_logs", $context) ? $context["debug_logs"] : (function () { throw new RuntimeError('Variable "debug_logs" does not exist.', 115, $this->source); })()), "debug"], 115, $this->getSourceContext());
                echo "
                    ";
            }
            // line 117
            ...
            if (twig_test_empty((isset($context["silenced_logs"]) || array_key_exists("silenced_logs", $context) ? $context["silenced_logs"] : (function () { throw new RuntimeError('Variable "silenced_logs" does not exist.', 125, $this->source); })()))) {
                ...
                // line 130
                echo "                        ";
                echo twig_call_macro($macros["helper"], "macro_render_table", [(isset($context["silenced_logs"]) || array_key_exists("silenced_logs", $context) ? $context["silenced_logs"] : (function () { throw new RuntimeError('Variable "silenced_logs" does not exist.', 130, $this->source); })()), "silenced"], 130, $this->getSourceContext());
                echo "
                    ";
            }
            // line 132
...
$context["log"], "priorityName", [], "any", false, false, false, 206) == "WARNING")) ? ("status-warning") : (""))))));
                ...
                echo "
                    <td class=\"font-normal\">";
                // line 226
                echo twig_call_macro($macros["helper"], "macro_render_log_message", [(isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 226, $this->source); })()), twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 226), $context["log"]], 226, $this->getSourceContext());
                echo "</td>
                </tr>
            ";
                ++$context['loop']['index0'];
...
{% macro render_log_message(category, log_index, log) %}
    ...
    {% endif %}
{% endmacro %}
", "@WebProfiler/Collector/logger.html.twig", "/var/www/cv/vendor/symfony/web-profiler-bundle/Resources/views/Collector/logger.html.twig");
    }
}

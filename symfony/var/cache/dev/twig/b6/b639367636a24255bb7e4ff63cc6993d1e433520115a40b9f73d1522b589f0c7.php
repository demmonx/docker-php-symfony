...
class __TwigTemplate_56762595cfee902a828befcedc3062bb04ce298c34ef717e6d8030f61b2c9226 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if ((isset($context["tokens"]) || array_key_exists("tokens", $context) ? $context["tokens"] : (function () { throw new RuntimeError('Variable "tokens" does not exist.', 22, $this->source); })())) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["result"]) {
                ...
                echo " ";
                echo twig_call_macro($macros["helper"], "macro_profile_search_filter", [(isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 43, $this->source); })()), $context["result"], "ip"], 43, $this->getSourceContext());
                echo "</span>
                        </td>
                        <td>
                            <span class=\"nowrap\">";
                ...
                echo " ";
                echo twig_call_macro($macros["helper"], "macro_profile_search_filter", [(isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 46, $this->source); })()), $context["result"], "method"], 46, $this->getSourceContext());
                echo "</span>
                        </td>
                ...
                echo "
                            ";
                // line 50
                echo twig_call_macro($macros["helper"], "macro_profile_search_filter", [(isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 50, $this->source); })()), $context["result"], "url"], 50, $this->getSourceContext());
                echo "
                        </td>
                        <td class=\"text-small\">
                            <span class=\"nowrap\">";
...
{% endblock %}
", "@WebProfiler/Profiler/results.html.twig", "/var/www/cv/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/results.html.twig");
    }
}
